(function ($) {
    ...
    $.fn.fSelect = function (options) {
        ...
        fSelect.prototype = {
            create: function () {
                ...
                this.$select.before('<div class="fs-label-wrap"><div class="fs-search"><input class="fs-search" type="search" placeholder="' + this.settings.searchText + '" /></div></div>');
    ...
    $(document).on('click', function (e) {
        ...
        if (0 < $wrap.length) {
            ...
            if ($el.hasClass('fs-search') || $el.hasClass('fs-arrow')) {
